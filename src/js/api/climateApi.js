...
function generateNorwayClimateData(stationKey = 'norway') {
  const startYear = 1900;
  const endYear = 2025;
  const years = [];
  
  const rawList = STATION_RAW_ANOMALIES[stationKey] || STATION_RAW_ANOMALIES.oslo_blindern || [
    -0.6, -0.4, -0.9, -0.5, -0.3, -0.7, -0.4, -0.8, -0.5, -0.2,
    -0.7, -0.3, -0.4, -0.2, -0.6, -0.8, -0.3,  0.1, -0.2, -0.5,
    -0.3, -0.1, -0.4, -0.6,  0.2, -0.2,  0.1, -0.3,  0.2,  0.1,
     0.3,  0.1,  0.4,  0.6,  0.8,  0.2,  0.5,  0.9,  0.7,  0.4,
    -1.4, -1.7, -1.5,  0.1,  0.2, -0.3,  0.3,  0.1,  0.4,  0.2,
    -0.4, -0.2,  0.1, -0.6,  0.3, -0.1,  0.2, -0.5, -0.3,  0.4,
    -0.8,  0.1, -0.3,  0.2,  0.0, -0.7, -1.1,  0.4, -0.2,  0.1,
    -0.3,  0.2,  0.5,  0.1, -0.4,  0.3,  0.0,  0.2,  0.4, -0.2,
    -0.1, -0.7,  0.2,  0.4,  0.5, -0.8,  0.2,  0.3,  0.7,  1.2,
     1.1,  0.8,  0.9,  0.4,  0.1,  0.6,  0.8,  0.7,  0.4,  0.9,
     1.2,  1.0,  1.3,  1.1,  1.4,  1.0,  1.5,  1.1,  1.4,  0.8,
     0.6,  1.5,  1.2,  1.4,  1.6,  1.5,  1.8,  1.4,  1.7,  1.5,
     2.1,  1.6,  1.7,  1.9,  2.2,  2.0
  ...
  // Beregn 10-års glidende gjennomsnitt (FIXED map parameters: item, index)
...
export async function getClimateDataForRegion(stationKey = 'norway', seasonKey = 'annual') {
  ...
  const stationSeries = generateNorwayClimateData(stationKey);
